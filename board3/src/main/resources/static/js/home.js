window.onload = () => {
    ...
    if (!sessionStorage.getItem("userName")) {
        ...
        document.getElementById("location_findPw").setAttribute("display", "inline-block");
    } else {
        document.getElementById("location_edit").setAttribute("display", "inline");
        document.getElementById("location_signUp").setAttribute("display", "none");
        document.getElementById("location_findId").setAttribute("display", "none");
        document.getElementById("location_findPw").setAttribute("display", "none");
    }
}
